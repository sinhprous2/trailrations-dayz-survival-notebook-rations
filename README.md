...
<div align="center">
  <img src="./public/logo.svg" alt="TrailRations — DayZ — Rations" width="64" height="64">
  <h1>TrailRations — DayZ — Rations</h1>
</div>

An independent project specification for DayZ, covering supply checklist, user-drawn route notes, session survival journal.
...
<img src="./public/screenshots/desktop-main.svg" alt="DayZ — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="DayZ — compact concept, not a screenshot" width="250">
<br>
...
- **Supply checklist** — planned module; not implemented.
- **User-drawn route notes** — planned module; not implemented.
- **Session survival journal** — planned module; not implemented.

The proposed workflow separates supply checklist from user-drawn route notes, with session survival journal retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Supply checklist**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="TrailRations — DayZ — Rations — specification review workflow">
<br>
...
Define the input and expected outcome for module 1. Record the DayZ version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### User-drawn route notes

Define the input and expected outcome for module 2. Record the DayZ version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Session survival journal

Define the input and expected outcome for module 3. Record the DayZ version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Supply checklist |
