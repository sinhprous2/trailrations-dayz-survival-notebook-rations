...
- [ ] Define a versioned input fixture specifically for supply checklist.
...
### 2. User-drawn route notes

- [ ] Define a versioned input fixture specifically for user-drawn route notes.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.

### 3. Session survival journal

- [ ] Define a versioned input fixture specifically for session survival journal.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.
